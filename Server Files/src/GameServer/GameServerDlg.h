...
#if __VERSION > 1960
	uint8   m_nBorderDefenseWarTime[BORDER_DEFENSE_WAR_EVENT_COUNT], m_nChaosTime[CHAOS_EVENT_COUNT], m_nUnderTheCastleTime[UNDER_THE_CASTLE_COUNT];
#else
